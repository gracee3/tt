...
Use this skill when the task is to spawn, coordinate, inspect, or retire Codex subagents.
...
- determine whether the child should run locally, remotely, or as a shared app-server backed Codex session
- verify what state already exists before spawning another agent

## Tools

- `codex --remote ...` for remote Codex sessions when the task belongs in the shared runtime
