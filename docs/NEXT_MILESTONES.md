...
- The daemon socket transport is live. The request surface now includes Codex thread lifecycle wiring, workspace actions, and daemon-state-first lifecycle operations; the next step is richer drill-down/selection ergonomics and cleanup of the remaining compatibility surfaces.
