---
name: tt
description: TT session and shared app-server coordination.
---

# tt

Use this skill when the task is to spawn, inspect, resume, or maintain TT sessions and the shared app-server they depend on.

## Scope

- owns TT session lifecycle and shared app-server coordination
...
- identify the active TT session or thread
...
- `tt --remote ...` for remote session access and resume flows
...
- keep app-server management subordinate to the current TT session goal
