//! Shared JSON-RPC, snapshot, and event vocabulary for TT.
//!
...
use crate::collaboration::{
    Assignment, AssignmentStatus, Decision, DecisionType, LandingAuthorizationRecord,
    LandingExecutionRecord, PlanningSession, PlanningSessionResearchStatus,
    ...
    Worker, WorkerSession, WorkspaceOperationRecord, Workstream, WorkstreamStatus,
};
...
pub mod methods {
    ...
    pub const RUNTIME_ASSIGNMENT_CREATE: &str = "tt_assignment/create";
    pub const RUNTIME_ASSIGNMENT_GET: &str = "tt_assignment/get";
    pub const RUNTIME_ASSIGNMENT_LIST: &str = "tt_assignment/list";
    pub const RUNTIME_ASSIGNMENT_PAUSE: &str = "tt_assignment/pause";
    pub const RUNTIME_ASSIGNMENT_RESUME: &str = "tt_assignment/resume";
    pub const RUNTIME_ASSIGNMENT_RELEASE: &str = "tt_assignment/release";
...
pub struct DaemonStatusResponse {
    ...
    pub tt_endpoint: String,
    pub tt_binary_path: String,
...
pub struct CollaborationSnapshot {
    ...
    #[serde(default)]
    pub tt_thread_assignments: Vec<TTThreadAssignmentSummary>,
    #[serde(default)]
...
pub enum DaemonEvent {
    ...
    TTAssignmentLifecycle {
        action: TTAssignmentLifecycleAction,
        assignment: TTThreadAssignmentSummary,
    },
...
/// Lifecycle verbs for TT assignment visibility events.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum TTAssignmentLifecycleAction {
    Created,
    Paused,
    Resumed,
    Released,
...
/// Summary view of a TT thread assignment mirror.
///
/// This is execution/runtime state, not planning authority state.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TTThreadAssignmentSummary {
    pub assignment_id: String,
    pub tt_thread_id: String,
    pub workstream_id: String,
    pub work_unit_id: String,
    ...
    pub updated_at: DateTime<Utc>,
    pub status: TTThreadAssignmentStatus,
    pub send_policy: TTThreadSendPolicy,
    pub bootstrap_state: TTThreadBootstrapState,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TTAssignmentCreateRequest {
    pub tt_thread_id: String,
    pub workstream_id: String,
    pub work_unit_id: String,
    pub supervisor_id: String,
    pub assigned_by: String,
    #[serde(default)]
    pub send_policy: Option<TTThreadSendPolicy>,
    #[serde(default)]
    pub notes: Option<String>,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TTAssignmentCreateResponse {
    pub assignment: TTThreadAssignment,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TTAssignmentGetRequest {
    pub assignment_id: String,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TTAssignmentGetResponse {
    pub assignment: TTThreadAssignment,
}

#[derive(Debug, Clone, Default, Serialize, Deserialize)]
pub struct TTAssignmentListRequest {
    #[serde(default)]
    pub tt_thread_id: Option<String>,
    #[serde(default)]
    pub workstream_id: Option<String>,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TTAssignmentListResponse {
    pub assignments: Vec<TTThreadAssignmentSummary>,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TTAssignmentPauseRequest {
    pub assignment_id: String,
    #[serde(default)]
    pub notes: Option<String>,
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TTAssignmentPauseResponse {
    pub assignment: TTThreadAssignment,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TTAssignmentResumeRequest {
    pub assignment_id: String,
    #[serde(default)]
    pub notes: Option<String>,
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TTAssignmentResumeResponse {
    pub assignment: TTThreadAssignment,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TTAssignmentReleaseRequest {
    pub assignment_id: String,
    #[serde(default)]
    pub notes: Option<String>,
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TTAssignmentReleaseResponse {
    pub assignment: TTThreadAssignment,
}
