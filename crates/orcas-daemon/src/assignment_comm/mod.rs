...
use orcas_core::{OrcasResult, ReportParseResult};
...
pub const REPORT_MARKER_BEGIN: &str = "ORCAS_REPORT_BEGIN";
pub const REPORT_MARKER_END: &str = "ORCAS_REPORT_END";
...
pub fn json_fingerprint<T: Serialize>(value: &T) -> OrcasResult<String> {
