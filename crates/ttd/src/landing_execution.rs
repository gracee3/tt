use tt_core::{LandingAuthorizationRecord, LandingExecutionRecord};
...
mod tests {
    ...
    fn sample_authorization() -> LandingAuthorizationRecord {
        LandingAuthorizationRecord {
            ...
            merge_prep_readiness: tt_core::ipc::TrackedThreadMergePrepReadiness::Ready,
            ...
            status: tt_core::LandingAuthorizationStatus::Authorized,
            request_note: None,
    ...
    fn sample_execution() -> LandingExecutionRecord {
        LandingExecutionRecord {
            ...
            status: tt_core::LandingExecutionStatus::Requested,
