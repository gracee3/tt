...
use tt_core::ipc::{
    ...
    OperatorRemoteActionWaitResponse, PlanningSessionApproveRequest,
    PlanningSessionApproveResponse, PlanningSessionCreateRequest, PlanningSessionCreateResponse,
    PlanningSessionListRequest, PlanningSessionListResponse,
...
impl TTServerClient {
    ...
    #[cfg(not(target_arch = "wasm32"))]
    async fn get_json<T: serde::de::DeserializeOwned>(&self, path: &str) -> TTResult<T> {
    ...
    pub async fn operator_inbox_get(
        ...
        origin_node_id: &str,
        item_id: &str,
    ) -> TTResult<OperatorInboxMirrorGetResponse> {
    ...
    ) -> TTResult<OperatorNotificationGetResponse> {
    ...
    ) -> TTResult<NotificationDeliveryJobGetResponse> {
    ...
    ) -> TTResult<OperatorRemoteActionWaitResponse> {
    ...
    pub async fn inbox_checkpoint(
        &self,
        origin_node_id: &str,
    ) -> TTResult<OperatorInboxMirrorCheckpointQueryResponse> {
    ...
    ) -> TTResult<OperatorInboxWaitForCheckpointResponse> {
    ...
    pub async fn state_get(&self, request: &StateGetRequest) -> TTResult<StateGetResponse> {
    ...
    ) -> TTResult<AssignmentStartResponse> {
    ...
    ) -> TTResult<ProposalCreateResponse> {
    ...
    ) -> TTResult<ProposalArtifactDetailGetResponse> {
    ...
    ) -> TTResult<ProposalApproveResponse> {
    ...
    ) -> TTResult<ProposalRejectResponse> {
    ...
    ) -> TTResult<AuthorityHierarchyGetResponse> {
    ...
    ) -> TTResult<AuthorityDeletePlanResponse> {
    ...
    ) -> TTResult<AuthorityWorkstreamCreateResponse> {
    ...
    ) -> TTResult<AuthorityWorkstreamEditResponse> {
    ...
    ) -> TTResult<AuthorityWorkstreamDeleteResponse> {
    ...
    ) -> TTResult<AuthorityWorkunitGetResponse> {
    ...
    ) -> TTResult<AuthorityWorkunitCreateResponse> {
    ...
    ) -> TTResult<AuthorityWorkunitEditResponse> {
    ...
    ) -> TTResult<AuthorityWorkunitDeleteResponse> {
    ...
    ) -> TTResult<AuthorityTrackedThreadCreateResponse> {
    ...
    ) -> TTResult<AuthorityTrackedThreadEditResponse> {
    ...
    ) -> TTResult<AuthorityTrackedThreadDeleteResponse> {
    ...
    ) -> TTResult<AuthorityTrackedThreadGetResponse> {
    ...
    ) -> TTResult<PlanningSessionCreateResponse> {
    ...
    ) -> TTResult<PlanningSessionListResponse> {
    ...
    ) -> TTResult<PlanningSessionRequestSupervisorContextResponse> {
        self.post_json(
    ...
    ) -> TTResult<PlanningSessionRequestResearchResponse> {
        self.post_json(
    ...
    ) -> TTResult<PlanningSessionMarkReadyForReviewResponse> {
    ...
    ) -> TTResult<PlanningSessionApproveResponse> {
    ...
    ) -> TTResult<PlanningSessionRejectResponse> {
        self.post_json("operator-runtime/planning-sessions/reject", request)
            .await
    }

    pub async fn thread_get(&self, request: &ThreadGetRequest) -> TTResult<ThreadGetResponse> {
    ...
    pub async fn tt_assignment_pause(
        &self,
        request: &TTAssignmentPauseRequest,
    ) -> TTResult<TTAssignmentPauseResponse> {
        self.post_json("operator-runtime/tt-assignments/pause", request)
            .await
    }

    pub async fn tt_assignment_resume(
        &self,
        request: &TTAssignmentResumeRequest,
    ) -> TTResult<TTAssignmentResumeResponse> {
        self.post_json("operator-runtime/tt-assignments/resume", request)
            .await
    }
}

pub mod prelude {
    pub use super::TTServerClient;
}
...
mod tests {
    ...
    async fn auth_header_is_required_for_operator_routes() {
        ...
        let unauthorized = TTServerClient::new(server_url.clone())
        ...
        let client = TTServerClient::with_operator_api_token(server_url, token);
        let response = client
            .operator_inbox_list(origin_node_id)
            .await
    ...
    async fn typed_read_models_decode_for_inbox_notifications_deliveries_and_actions() {
        ...
        let client = TTServerClient::with_operator_api_token(server_url.clone(), token.clone());
        let inbox = client
            .operator_inbox_list(origin_node_id)
            .await
            .expect("inbox list");
    ...
    async fn read_model_checkpoints_round_trip_through_the_client() {
        ...
        let client = TTServerClient::with_operator_api_token(server_url.clone(), token);
    ...
    async fn recipient_and_subscription_registration_round_trip_through_the_client() {
        ...
        let recipient = client
            .notification_recipient_upsert(&NotificationRecipientUpsertRequest {
                ...
                display_name: "TT web browser origin-a".to_string(),
                enabled: true,
            })
            .await
    ...
    async fn request_and_auth_errors_are_surfaces_cleanly() {
        ...
        let unauthorized = TTServerClient::new(server_url.clone())
            .remote_action_list(&tt_core::ipc::OperatorRemoteActionListRequest {
                origin_node_id: origin_node_id.to_string(),
                ..Default::default()
            })
            .await;
